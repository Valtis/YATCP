...
mod tests {
    ...
    fn hexadecimals_are_accepted() {
        ...
        assert_eq_token!(
            lexer.next_token(),
            TokenType::Number,
            TokenSubType::IntegerNumber(255));
        ...
        assert_eq_token!(
            lexer.next_token(),
            TokenType::Number,
            TokenSubType::IntegerNumber(128));

        assert_eq_token!(
            lexer.next_token(),
            TokenType::Number,
            TokenSubType::IntegerNumber(25987610));
    ...
    fn binary_numbers_are_accepted() {
        ...
        assert_eq_token!(
            lexer.next_token(),
            TokenType::Number,
            TokenSubType::IntegerNumber(341));

        assert_eq_token!(
            lexer.next_token(),
            TokenType::Number,
            TokenSubType::IntegerNumber(113019));
