...
condition_answer_pairs = [
	...
	("const_variable_should_take_if_statement_with_greater_or_eq_comparison_when_lhs_is_equal", 
		...
		"2  >= val", 
		IF_STATEMENT_TAKEN),
	("const_variable_should_not_take_if_statement_with_greater_or_eq_comparison_when_lhs_is_greater", 
		"let val: int = 2;", 
		"3  >= val", 
		IF_STATEMENT_TAKEN),
	...
	("const_variable_should_not_take_if_statement_with_greater_than_comparison_when_lhs_is_less", 
		"let val: int = 2;",
		 "1  > val", 
		 IF_STATEMENT_NOT_TAKEN),
	("const_variable_should_take_if_statement_with_greater_than_comparison_when_lhs_is_equal", 
		"let val: int = 2;", 
		"2  > val", 
		IF_STATEMENT_NOT_TAKEN),
